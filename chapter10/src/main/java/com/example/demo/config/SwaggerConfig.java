...
import com.example.demo.entity.SwaggerProperties;
...
/**
 * @author: gq
 * @createtime: 2020/12/8 10:02
 * @description: swagger配置文件
 */
//声明一个类作为配置类，代替xml文件，spring启动到时候会自动扫描
@Configuration
@EnableOpenApi
...
//    是否开启swagger，正式环境一般是需要关闭的
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.OAS_30)
                ...
                //当前包路径,设置basePackage会将包下的所有被@Api标记类的所有方法作为api
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                //创建人
                .contact(new Contact("gq", "", "253758897@qq.com"))
                //版本号
